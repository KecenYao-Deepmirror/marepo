...
class CamLocDataset(Dataset):
    ...
    def __init__(self,
        ...
        Parameters:
            ...
            load_rgb: If True, we load image in colors, not in gray scale
        ...
        # print("self.default_img_H, self.default_img_W", self.default_img_H, self.default_img_W)
        # tmp = self._get_single_item(0, self.image_height)
        # tmp = self.__getitem__([5,8])
